...
- Actions for activating/deactivating Daytona snapshots, accepting/declining organization invitations, linking/unlinking secondary user accounts, starting SMS MFA enrollment, leaving/suspending/unsuspending organizations, starting sandbox backups/snapshots/forks/recovery, expiring/revoking sandbox access tokens, updating sandbox last activity, and initializing/refreshing Daytona webhooks with Terraform 1.14 provider-defined actions.

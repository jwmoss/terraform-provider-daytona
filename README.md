...
```shell
go install github.com/536tech/terraform-provider-daytona@v0.8.1
...
module "daytona_sandbox" {
  source = "github.com/536tech/terraform-provider-daytona//examples/modules/daytona-sandbox?ref=v0.8.1"

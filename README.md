...
```shell
go install github.com/jwmoss/terraform-provider-daytona@v0.4.0
...
module "daytona_sandbox" {
  source = "github.com/jwmoss/terraform-provider-daytona//examples/modules/daytona-sandbox?ref=v0.4.0"

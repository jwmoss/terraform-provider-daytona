...
| Sandbox access, actions, and relationships | `daytona_sandbox_ssh_access`, `daytona_sandbox_build_logs_url`, `daytona_sandbox_port_preview_url`, `daytona_sandbox_signed_port_preview_url`, `daytona_sandbox_toolbox_proxy_url`, `daytona_sandbox_organization`, `daytona_sandbox_region_quota`, `daytona_sandbox_parent`, `daytona_sandbox_ancestors`, and `daytona_sandbox_forks` cover Terraform-readable sandbox access URLs and topology/quota lookups. `daytona_recover_sandbox`, `daytona_create_sandbox_backup`, `daytona_create_sandbox_snapshot`, `daytona_fork_sandbox`, `daytona_update_sandbox_last_activity`, `daytona_expire_sandbox_signed_port_preview_url`, and `daytona_revoke_sandbox_ssh_access` expose sandbox operations as Terraform 1.14 provider-defined actions. |

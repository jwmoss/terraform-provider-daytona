...
page_title: "daytona_sandboxes Data Source - daytona"
subcategory: ""
description: |-
  Lists Daytona sandboxes visible to the configured credentials.
---

# daytona_sandboxes (Data Source)
...
```terraform
data "daytona_sandboxes" "example" {}
```

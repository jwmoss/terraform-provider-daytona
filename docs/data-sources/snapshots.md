...
page_title: "daytona_snapshots Data Source - daytona"
subcategory: ""
description: |-
  Lists Daytona snapshots visible to the configured credentials.
---

# daytona_snapshots (Data Source)
...
```terraform
data "daytona_snapshots" "example" {}
```

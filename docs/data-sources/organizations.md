...
page_title: "daytona_organizations Data Source - daytona"
subcategory: ""
description: |-
  Lists Daytona organizations visible to the configured credentials.
---

# daytona_organizations (Data Source)
...
```terraform
data "daytona_organizations" "example" {}
```
